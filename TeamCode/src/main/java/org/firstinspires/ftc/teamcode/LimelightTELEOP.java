...
@TeleOp(name="Limelight Auto Align & Launch", group="Competition")
public class LimelightTELEOP extends OpMode {
    ...
    private ElapsedTime limelightQueryTimer = new ElapsedTime();
    ...
    private static final String LIMELIGHT_IP = "limelight.local";  // ADJUST: Use "limelight.local" or static IP like "192.168.43.11"
    ...
    public void loop() {
        ...
        telemetry.addData("Target Distance", "%.1f in", filteredDistance);
        telemetry.addData("Target RPM", "%.0f", targetVelocity);
        telemetry.addData("Motor 1 RPM", "%.0f", launcherMotor1.getVelocity());
        telemetry.addData("Motor 2 RPM", "%.0f", launcherMotor2.getVelocity());
        telemetry.addData("", "");
        telemetry.addData("Limelight TX", "%.2f°", limelightTx);
        telemetry.addData("Limelight TY", "%.2f°", limelightTy);
        ...
        telemetry.addData("Thread Running", threadRunning);
        telemetry.addData("Tx", limelightTx);
        telemetry.addData("Ty", limelightTy);
        telemetry.addData("Detected Tag ID", detectedTagId);
    ...
    /**
     * Query Limelight for AprilTag data via REST API
     */
    private void queryLimelight() {
        try {
            ...
            parseLimelightData(response.toString());
