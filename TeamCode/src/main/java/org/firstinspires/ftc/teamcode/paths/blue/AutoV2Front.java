...
@Autonomous(name = "9 Ball BLUE - Rapid Fire", group = "Auto")
public class AutoV2Front extends OpMode {
    ...
    private static final double SHOOT_POWER = 0.45;  // 46% of max RPM
    ...
    // Waypoints
    private static final Pose startPos = new Pose(25, 128.441, Math.toRadians(143));
    private static final Pose shotPos = new Pose(58, 90, Math.toRadians(140));
    private static final Pose intakePos1 = new Pose(57.8, 84.5, Math.toRadians(0));
    private static final Pose intakeEnd1 = new Pose(27, 84.5, Math.toRadians(0));
    private static final Pose intakePos2 = new Pose(57.5, 58, Math.toRadians(0));
    private static final Pose intakeEnd2 = new Pose(30, 58, Math.toRadians(0));
    ...
    public void init() {
        ...
        telemetry.addData("Status", "Initialized - BLUE 9 BALL");
        telemetry.update();
    }
