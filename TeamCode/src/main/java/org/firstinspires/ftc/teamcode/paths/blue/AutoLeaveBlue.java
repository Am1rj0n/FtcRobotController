...
@Autonomous(name = "3 Ball BLUE LEAVE - Rapid Fire", group = "Auto")
public class AutoLeaveBlue extends OpMode {
    ...
    private static final Pose shotPos = new Pose(57.931, 13.903, Math.toRadians(114));
    private static final Pose leavePos = new Pose(35.752, 13.903, Math.toRadians(0));
    ...
    public void init() {
        ...
        telemetry.addData("Status", "Initialized - BLUE LEAVE 3 BALL");
        telemetry.update();
    }
