...
@Autonomous(name = "6 Ball RED BACK - Rapid Fire", group = "Auto")
public class AutoBackRed extends OpMode {
    ...
    private static final double PATH_TIMEOUT_MS = 6000;
    ...
    private static final Pose startPos = new Pose(57.434, 8.938, Math.toRadians(90)).mirror();
    private static final Pose shotPos = new Pose(60.000, 16.500, Math.toRadians(111)).mirror();
    private static final Pose intakePos1 = new Pose(59.752, 36.579, Math.toRadians(0)).mirror();
    private static final Pose intakeEnd1 = new Pose(17.214, 36.579, Math.toRadians(0)).mirror();
    private static final Pose leavePos = new Pose(36.248, 11.586, Math.toRadians(0)).mirror();
    private static final Pose curveControl = new Pose(52.469, 36.248).mirror();
    ...
    public void init() {
        ...
        telemetry.addData("Status", "Initialized - RED BACK 6 BALL");
        telemetry.update();
    }
