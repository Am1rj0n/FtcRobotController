...
public class AutoFarBlue extends OpMode {
    ...
    public void init() {
        ...
        panelsTelemetry.debug("Status", "Auto Far Blue - Ready");
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            // (56,8,90°) → (55.737,10.895,111°)
            shoot0 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(56.000, 8.000), new Pose(55.737, 10.895)))
                    .setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(111))
                    .build();

            // (55.737,10.895,111°) → (44.368,35.053,180°)
            intake1pos = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(55.737, 10.895), new Pose(44.368, 35.053)))
                    .setLinearHeadingInterpolation(Math.toRadians(111), Math.toRadians(180))
                    .build();

            // (44.368,35.053,180°) → (9.947,34.895,180°)
            intake1 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(44.368, 35.053), new Pose(9.947, 34.895)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            // (9.947,34.895,180°) → (55.895,10.895,111°)
            shoot1 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(9.947, 34.895), new Pose(55.895, 10.895)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(111))
                    .build();

            // ── Cycle 2 ──────────────────────────────────────────────────────

            // (55.895,10.895,111°) → curve → (20,8,180°)
            intakepos2 = follower.pathBuilder()
                    .addPath(new BezierCurve(
                            new Pose(55.895, 10.895),
                            new Pose(43.316, 20.395),
                            new Pose(20.000,  8.000)
                    ))
                    .setLinearHeadingInterpolation(Math.toRadians(111), Math.toRadians(180))
                    .build();

            // Pass 1 — forward: (20,8) → (8,8)
            intake2 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(20.000, 8.000), new Pose(8.000, 8.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            // Pass 2 — reverse: (8,8) → (19.553,8.553)
            intake2retry = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(8.000, 8.000), new Pose(19.553, 8.553)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            // Pass 3 — forward: (19.553,8.553) → (8.276,7.882)
            intake2done = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(19.553, 8.553), new Pose(8.276, 7.882)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            // (8.276,7.882,180°) → curve → (56,11,111°)
            shoot2 = follower.pathBuilder()
                    .addPath(new BezierCurve(
                            new Pose(8.276,   7.882),
                            new Pose(33.974, 18.395),
            ...
            // (56,11,111°) → curve → (20,8,180°)   [same curve as intakepos2]
            ...
            // (56,11,111°) → (36.316,10.842,90°)
            park = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(56.000, 11.000), new Pose(36.316, 10.842)))
