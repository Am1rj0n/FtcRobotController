...
@TeleOp(name = "MegaTag2 Backup Red", group = "BackUp")
public class MegaTag2TeleOpRed extends OpMode {
    ...
    public void init() {
        ...
        telemetry.addLine("╔═══ MEGATAG2 RED INIT ═══╗");
    ...
    private void displayTelemetry() {
        ...
        telemetry.addLine("╔═══ MEGATAG2 RED ═══╗");
