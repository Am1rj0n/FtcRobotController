...
/**
 * SoloDriverTurretRed — single primary gamepad + GP2 RPM fine adjust.
 *
 * ─────────────────────────────────────────────────────────────────────────────
 *  GP1 CONTROLS
 * ─────────────────────────────────────────────────────────────────────────────
...
public class SoloDriverTurretRed extends OpMode {
    ...
    public void init() {
        ...
        telemetry.addData("Status", "Solo Driver Turret Red [TEST] - Ready");
        telemetry.update();
    }
    ...
    private void displayTelemetry() {
        ...
        telemetry.addLine("╔═══ SOLO DRIVER TURRET RED [TEST] ═══╗");
